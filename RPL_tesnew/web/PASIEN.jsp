...
<html lang="en">
    ...
    <head>
        ...
        %>
        <title>Home - Pasien <%=session.getAttribute("username")%></title>
    ...
    <body style="overflow-x: hidden">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="#about">Halaman Utama Pasien</a>
                        </li>                    
        ...
        <section class=" color-light" id="work-sec" >
            <div class="container" >
                ...
                <div class="row text-center" >
                    <div class="col-md-12" >
                        ...
                        <div class="row">
                            <a href="BuatJanji.jsp#about" class="btn" style="background-color: #fff;border-radius: 15px;box-shadow: 0px 2px 2px #848484" >
                                ...
                                <p style="float: left; width: 300px;height: 150px;margin: 1em; " class="text-left">
                                    <i style="font-size: 30px"><br>Membuat janji</i><br>
                            ...
                            <a href="AkunSet.jsp#about" class="btn" style=" background-color: #fff; border-radius: 15px ;box-shadow: 0px 2px 2px #848484">
                                <img src="assets/Images/akunsetting.png" style="float: left; width: 200px;height: 200px;margin: 1em;margin-left: px">
                                <p style="float: left; width: 300px; height: 150px;margin: 1em; padding-right: 50px; " class="text-left">
                                    <i style="font-size: 30px"><br>Pengaturan </i><br>
