            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    <ul class="nav navbar-nav">
                        <li><a href="#home"><< Halaman Utama Dokter</a>
                        </li>
                        <li>
                            <a href="Login.jsp" class="navbar-left fixed btn-group-justified breadcrumb" style="text-shadow: 2px 0px 2px #333;z-index: 99; padding: 15px; margin-left: 400px; background-color: #84bd17; border-radius: 20px; opacity: 1.0; position: absolute; width: 1000px">
                                Logout
                            </a>
                        </li>
        ...
        <section class=" color-light"  >
            <div class="container" >
                ...
                <div class="row text-left" >
                    <div>
                        <h1 class="text-center"> INPUT REKAM MEDIS </h1>
                        ...
                        <div class="form-control" style="height: 1000px ; padding-left: 100px;padding-right: 100px; background-color: #c1c1c1; width: 1200px">
                            ...
                            <form action="" method="post" class="register">
                                ...
                                <fieldset class="row1 col-lg-4" style="text-align: center; height: 150px; padding: 0px 12px 50px 12px">
                                    <legend>
                                        Tanggal
                                    </legend>
                                    <p>
                                        <input type="date" id="my-input"  style="margin-left: 335px " required><br>
                                    </p>

                                </fieldset>

                                <fieldset class="row1">
                                    <legend>Data Fisik Pasien
                                    </legend>
                                    <p>
                                        <label style="margin-right: 10px">Tinggi Badan (cm)*
                                        </label>
                                ...
                                <fieldset class="row1" style="">
                                    <button class="buttonform">Simpan &raquo;</button>
                                </fieldset>
